...
- The widgets we make should be from wigggle-ui: dashboard, clock, calendar, productivity, weather, stocks, and stocks.
- Widgets should be able to read and be connected to one another.
- Widgets should be simple.
- Lets follow the styles from wigggle-ui but allow for overrides from vscode theme.
- We should have settings and connections UI that is easy to use and intuitive.
